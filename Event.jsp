...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="AEventServlet"  method="post">
...
<br>
      ...
      <input type="text" placeholder="Enter Description" name="EDescription" required>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="UEventServlet" method="post">
    <div class="imgcontainer">
...
<body> <button onclick="document.getElementById('id03').style.display='block'" style="width:auto;">Delete</button>
</div>

<div id="id03" class="modal">
  
  <form class="modal-content animate" action="DEventServlet" method="post">
    <div class="imgcontainer">
